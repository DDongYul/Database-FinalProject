#execute를 이용해 하나의 영화씩 insert + try except문을 사용해 에러가 난 부분 exception_table에 저장 에러가 난 영화는 아예 insert x + 1페이지에서 멈춘경우
...
def main():
    ...
    for year_dir_link in year_dir_link_lst:             
        ...
        if page_is_ok == False and goto_page != '1':#addingv2 goto_page != 1
        ...
        while 1:
            #adding.....
            if page_is_ok == False and goto_page == '1':#addingv2
                page_is_ok = True
